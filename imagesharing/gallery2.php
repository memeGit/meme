...
<?
                    ...
                    while ($line = mysql_fetch_array($result)) {
						...
						<img src="<?=$line[filepath].$line[tn_filename] ?>">
            ...
            <table border="0" width="100%" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td valign="top" align="center">
                        <div name="galimage" id="<?=$line[filename]?>">
                            <a href="view.php?filename=<?= $line[filename] ?>">
                                <img class="displayimage" src="<?=$line[filepath].$line[tn_filename] ?>" alt="<?= $line[filename]?>" title="<?= $line[filename]?>" >
                            </a>
                            <br /><br />
                            <? if($auth_gid=="1" || $auth_gid=="2") {?>
                        </div>                    
                        <input type="checkbox" name="deleteFN[]" onclick="change(this);" value="<?= $line[filename] ?>"><?}?>  <?=$short_name?>                    
                    </td>
                    <?
                    //if ($ctr % 3 == 0) {
                    ?>
