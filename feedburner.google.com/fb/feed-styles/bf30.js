...
function subscribeNow(readerHref,readerString) {
	...
	switch (readerString) {
		...
		case "Plusmo":
			cookieReaderHref = "../plusmo.com/add@url={feed}"
			break;

		case "Windows Live":
			cookieReaderHref = "../www.live.com/@addFeed={feed}"
			break;

		case "Google":
			cookieReaderHref = "../fusion.google.com/add@feedurl={feed}"
			break;
		
		case "My Yahoo!":
			cookieReaderHref = "../add.my.yahoo.com/rss@url={feed}"
			break;

		case "Feedness":
			cookieReaderHref = "../www.feedness.com/alta/{feed}"
			break;
			
		case "NewsGator Online":
			cookieReaderHref = "../www.newsgator.com/ngs/subscriber/subext.aspx@url={feed}"
			break;
						
		case "My AOL":
			cookieReaderHref = "../feeds.my.aol.com/add.jsp@url={feed}"
			break;
			
		case "Rojo":
			cookieReaderHref = "../www.rojo.com/add-subscription@resource={feed}"
			break;
		
		case "Bloglines":
			cookieReaderHref = "../www.bloglines.com/sub/{feed}"
			break;
						
		case "Pluck":
			cookieReaderHref = "../client.pluck.com/pluckit/prompt.aspx@GCID=C12286x053&a={feed}&t={title}"
			break;

		case "podnova":
			cookieReaderHref = "../www.podnova.com/add.srf@url={feed}"
			break;

		case "Netvibes":
			cookieReaderHref = "../www.netvibes.com/subscribe.php@url={feed}"
			break;

		case "Livedoor":
			cookieReaderHref = "../reader.livedoor.com/subscribe/{feed}";
			break;

		case "goo":
			cookieReaderHref = "../reader.goo.ne.jp/web/bookmarklet.html@,,{feed}";
			break;			

        case "Pageflakes":
            cookieReaderHref = "../www.pageflakes.com/subscribe.aspx@url={feed}"    
            break;

        case "ODEO":
			cookieReaderHref = "../odeo.com/listen/subscribe@feed={feed}"
			break;

		case "Paipo":  
			cookieReaderHref = "../paipo.jp/bookmarklet/@url={feed}"
			break;

		case "My Yahoo! Japan": //japan
			cookieReaderHref = "../add.my.yahoo.co.jp/rss@url={feed}"
			break;

		case "feedpath": 
			cookieReaderHref = "../feedpath.jp/feedreader/feeds_add@url={feed}"
			break;

		case "hatena": 
			cookieReaderHref = "../r.hatena.ne.jp/append/{feed}"
			break;

    case "sleipnir":
      cookieReaderHref = "../www.fenrir.co.jp/rd/@rss={feed}"
      break;

    case "ExciteJP":
      cookieReaderHref = "../reader.excite.co.jp/subscribe/@url={feed}"
      break;

        case "yandex":
            cookieReaderHref = "../lenta.yandex.ru/settings.xml@name=feed&url={feed}"
            break;
