...
<div class="content form_photo">
	<form id="form-modal-post-image" class="modal" action="/submit/photo" enctype="multipart/form-data" method="post">
		...
		<div class="field">
			<label>
				<h4>Pic File</h4>
				<input id="photo_file_upload" class="file text " type="file" name="image" accept="image/gif,image/jpeg,image/jpg,image/png" style="display:;"></input>
				<input id="photo_post_url" type="text" class="text " name="url" value="" style="display:none;"></input>
			</label>
			<p class="info">
								<input type="hidden" name="file" value="1"/>
				<a class="post_link" href="photo"><strong>貼上圖片網址。</strong></a>
